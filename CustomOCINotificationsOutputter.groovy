 ...
 */
class CustomOCINotificationsOutputter 
  implements LogGenerator.RecordLogEvent
{
  ...
  */
  ...
  {
    CustomOCINotificationsOutputter notificationsOut = new CustomOCINotificationsOutputter();
